      ...
      >
        <CustomBreadcrumbs
          ...
          links={[
            ...
            {
              name: 'Equipos',
              href: PATHS.dashboard.campeonatos.manageEquiposCopa(params.idCampeonato || ''),
            },
            {
...
export default EquipoCopaEditPage;
