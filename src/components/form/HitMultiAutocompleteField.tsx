...
export type HitMultiAutocompleteFieldProps<
...
/**
 * Mui multiple Autocomplete wrapper. Check HitFreeSoloAutocomplete for arbitraty values.
 ...
 *    name="roles"
 *    control={hf.control}
 *    render={(field) => <HitMultiAutocompleteField
 *      {...field}
 *      label="Roles"
...
export const HitMultiAutocompleteField = <TValue extends FieldValues>({
  label,
  colSpan,
  options,
  field,
  ...
  fieldState,
  ...props
}: HitMultiAutocompleteFieldProps<TValue>) => {
  ...
  return (
    <GridItem colSpan={colSpan}>
      ...
      <Autocomplete
        ...
        id={id}
        multiple
        onChange={(ev, value) => value && hf.setValue(field.name, value as any)}
